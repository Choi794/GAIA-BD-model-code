...
setwd("E:/GAIA_BD/final_77777777777/Abundance/Abundance2")
data <- fread("Abundance_covariate_new12.csv")
...
# Save the plot
jpeg("E:/GAIA_BD/The Biodiversity Knowledge Paradox/figure/RandomForest2/OLS_abundance_final.jpg", res = 600, width = 10, height = 10, units = "in")
print(p_marginal)
dev.off()
